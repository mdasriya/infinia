    ...
    <div className="bg-white">
      <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
        ...
        <div className="grid grid-cols-2  grid-rows-2 gap-4 sm:gap-6 lg:gap-8">
          <img
            src="https://i.postimg.cc/sxWhmdht/flyashbrick.png"
          ...
          />
          <img
            src="https://5.imimg.com/data5/SELLER/Default/2021/3/WY/EV/DR/107133445/pvc-fly-ash-brick-pallet-500x500.jpeg"
            alt="Side of walnut card tray with card groove and recessed card area."
            className="rounded-lg bg-gray-100"
          />
          <img
            src="https://5.imimg.com/data5/ANDROID/Default/2023/4/300170251/BL/YD/KD/187357198/product-jpeg-500x500.jpg"
